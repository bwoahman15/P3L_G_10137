  ...
  <head>
    ...
    <div class="container p-3 m-4 h-100" style="background-color: #FFFFFF" >
        ...
        <div class="d-grid gap-2">
            <a href="./tambahPromoPage.php?id='.$data[0].'"><i style="color:blue" class="fa fa-plus fa-2x pull-right" ></i></a>
        </div>
        ...
        <hr>
            <table class="table">
                ...
                <form action="./promo.php" method="post">
                    <input type="search" class="form-control" id="jenis_promo" name="jenis_promo" aria-describedby="emailHelp">
                ...
                if(isset($_POST['cari'])){
                    ...
                    $nama_driver = $_POST['jenis_promo'];

                    $query = mysqli_query($con, "SELECT * FROM promo WHERE jenis_promo LIKE '%$jenis_promo%'") or die(mysqli_error($con));
                }else{
    ...
    <tr style="text-align:center">
        ...
        <td>'.$data[5].'</td>
        <td>
            <a href="./editPromoPage.php?id='.$data[0].'"><i style="color: green" class="fa fa-edit"></i></a>
            <a href="../process/hapusPromoProcess.php?id='.$data[0].'"
