...
<div class="container">
<a class="navbar-brand fw-bold" href="index.php">Atma Jaya Rental</a>

<div class="d-flex justify-content-end">
<button class="btn btn-primary me-2" type="button" >
<a class="text-light" style="text-decoration: none" href="registerCustomerPage.php">Register</a>
</button>
...
<div class=" pt-5 mt-4 ">
<h2 class="px-5 text-center">Selamat Datang di Atma Jaya Rental</h2>
</div>
</div>
</div>
