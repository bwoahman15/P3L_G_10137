  ...
  <head>
    ...
    <div class="container p-3 m-4 h-100" style="background-color: #FFFFFF" >
        ...
        <div class="d-grid gap-2">
            <a href="./tambahCustomerPage.php?id='.$data[0].'"><i style="color:blue" class="fa fa-plus fa-2x pull-right" ></i></a>
        </div>
        ...
        <hr>
            <table class="table">
                ...
                if(isset($_POST['cari'])){
                    ...
                    $query = mysqli_query($con, "SELECT * FROM customer WHERE nama_customer LIKE '%$nama_customer%'") or die(mysqli_error($con));
                }else{
    ...
    <tr style="text-align:center">
        ...
        <td>'.$data[7].'</td>
        <td>
            <a href="./editCustomerPage.php?id='.$data[0].'"><i style="color: green" class="fa fa-edit"></i></a>
            <a href="../process/hapusCustomerProcess.php?id='.$data[0].'"
